...
<div class="container-fluid">
  <div class="row mb-3">
    <div class="col">
      <h1 class="h3">Crear Modelo de Máquina</h1>
    </div>
  ...
  <div class="card">
    <div class="card-body">
      <form action="{{ route('modelos-maquina.store') }}" method="POST">
        @csrf
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="codigo_modelo_ips" id="codigo_modelo_ips" value="{{ old('codigo_modelo_ips') }}"
        ...
        <div class="text-end">
          <button type="submit" class="btn btn-outline-danger">
            <i class="bi bi-save"></i> Guardar Modelo
          </button>
        </div>
      </form>
    </div>
