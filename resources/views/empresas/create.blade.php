    ...
    <div class="card-body">
      <form method="POST" action="{{ route('empresas.store') }}">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="n_empresa_conta" id="n_empresa_conta" class="form-control" value="{{ old('n_empresa_conta') }}" required>
        </div>

        <div class="mb-3">
          <label for="n_empresa_ips" class="form-label">Código empresa IPS</label>
          <input type="text" name="n_empresa_ips" id="n_empresa_ips" class="form-control" value="{{ old('n_empresa_ips') }}">
        </div>
